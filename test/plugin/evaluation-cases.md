...
| “Do DEMO-101 prep for the week of 2026-10-05.” | `prepare-class`; uses that exact week and course, checks for an existing same-period artifact before running, verifies reported path/period and substantive, source-supported answers to each question—not merely three question headings. |
