...
- **Draft cannot be revised/approved:** verify the run ID and that its provenance-bearing Markdown remains under the vault's course `drafts/` path. The CLI locates runs from local draft artifacts.
